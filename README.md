## grepros (noetic) - 1.0.0-1

The packages in the `grepros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release grepros --rosdistro noetic` on `Thu, 13 Jul 2023 17:57:25 -0000`
...
## grepros (foxy) - 0.6.0-1

The packages in the `grepros` repository were released into the `foxy` distro by running `/usr/bin/bloom-release grepros --rosdistro foxy` on `Thu, 30 Mar 2023 17:40:45 -0000`
...
## grepros (noetic) - 0.6.0-2

The packages in the `grepros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release grepros --rosdistro noetic` on `Thu, 30 Mar 2023 17:38:00 -0000`
...
## grepros (noetic) - 0.6.0-1

The packages in the `grepros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release grepros --rosdistro noetic` on `Thu, 30 Mar 2023 17:27:44 -0000`
...
## grepros (foxy) - 0.5.0-1

The packages in the `grepros` repository were released into the `foxy` distro by running `/usr/bin/bloom-release grepros --rosdistro foxy` on `Sun, 30 Oct 2022 13:22:49 -0000`
...
## grepros (noetic) - 0.5.0-1

The packages in the `grepros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release grepros --rosdistro noetic` on `Sun, 30 Oct 2022 13:17:20 -0000`
...
## grepros (foxy) - 0.4.7-1

The packages in the `grepros` repository were released into the `foxy` distro by running `/usr/local/bin/bloom-release grepros --rosdistro foxy` on `Sat, 25 Jun 2022 18:02:12 -0000`
